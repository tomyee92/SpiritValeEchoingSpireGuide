...
window.SPIRE_DATA = {
  ...
  bosses: [
    { floor: 5, level: 105, name: "Vorpal Hare", def: "DEF", multi: false,
    ...
    { floor: 25, level: 125, name: "Cactus King", def: "DEF", multi: false,
    ...
    { floor: 30, level: 130, name: "Lady Fey", def: "MDEF", multi: true,
    ...
    { floor: 35, level: 135, name: "Hermit King", def: "DEF", multi: false,
    ...
    { floor: 35, level: 135, name: "Scorpion King", def: "DEF", multi: false,
    ...
    { floor: 40, level: 140, name: "Naga", def: "DEF", multi: false,
    ...
    { floor: 40, level: 140, name: "Night Baron", def: "DEF", multi: false,
      elements: [["Neutral", 86], ["Poison", 14]], mix: { mel: 77, ran: 9, mag: 14 }, autoPct: 60, swings: 124,
      cc: [], dot: [["Poison", "10s"]], deb: ["Blind"],
      prepare: "DEF Neutral", notes: "", drops: [], links: [] },

    { floor: 45, level: 145, name: "Zombie Orc Lord", def: "DEF", multi: false,
    ...
    { floor: 45, level: 145, name: "Orc King", def: "DEF", multi: false,
    ...
    { floor: 50, level: 150, name: "Ice Mage", def: "MDEF", multi: false,
    ...
    { floor: 55, level: 155, name: "Seraphim Arbiter", def: "MDEF", multi: false,
    ...
    { floor: 60, level: 160, name: "Broodmother", def: "SPLIT", multi: true,
    ...
    { floor: 60, level: 160, name: "Devourer", def: "DEF", multi: true,
    ...
    { floor: 65, level: 165, name: "Demon Lord", def: "MDEF", multi: true,
    ...
    { floor: 70, level: 170, name: "Abyss Archon", def: "MDEF", multi: true,
    ...
    { floor: 75, level: 175, name: "Orc Warchief", def: "SPLIT", multi: false,
    ...
    { floor: 80, level: 180, name: "Ice Titan", def: "DEF", multi: true,
    ...
    { floor: 85, level: 185, name: "Turtle Champion", def: "SPLIT", multi: true,
    ...
    { floor: 85, level: 185, name: "Kraken", def: "SPLIT", multi: true,
    ...
    { floor: 90, level: 190, name: "Cosmic Entity", def: "SPLIT", multi: true,
    ...
    { floor: 90, level: 190, name: "Wraith King", def: "SPLIT", multi: false,
    ...
    { floor: 95, level: 195, name: "Suphara", def: "DEF", multi: false,
    ...
    { floor: 95, level: 195, name: "Robot Dragon", def: "DEF", multi: false,
    ...
    { floor: 101, level: 201, name: "Echo Paladin Master", def: "MDEF", multi: false,
    ...
    { floor: 101, level: 201, name: "Echo Gunslinger Master", def: "DEF", multi: false,
      elements: [["Neutral", 100]], mix: { mel: 2, ran: 98, mag: 0 }, autoPct: 2, swings: 9,
      cc: [], dot: [], deb: ["Vulnerability", "Weaken", "Marked", "Slow"],
      prepare: "DEF Neutral", notes: "", drops: [], links: [] },

    { floor: 101, level: 201, name: "Echo Wizard Master", def: "MDEF", multi: true,
    ...
    { floor: 101, level: 201, name: "Echo Priest Master", def: "MDEF", multi: false,
    ...
    { floor: 101, level: 201, name: "Echo Shinobi Master", def: "DEF", multi: false,
    ...
    { floor: 101, level: 201, name: "Echo Necromancer Master", def: "SPLIT", multi: true,
    ...
    { floor: 101, level: 201, name: "Echo Berserker Master", def: "DEF", multi: false,
      elements: [["Neutral", 100]], mix: { mel: 100, ran: 0, mag: 0 }, autoPct: 13, swings: 91,
      cc: [["Stun", "3s", 75], ["Stun", "3s", 100]], dot: [["Bleed", "5s"]], deb: ["Stagger", "Slow"],
      prepare: "DEF Neutral · +anti-Stun", notes: "", drops: [], links: [] },

    { floor: 101, level: 201, name: "Echo Weaver Master", def: "SPLIT", multi: true,
